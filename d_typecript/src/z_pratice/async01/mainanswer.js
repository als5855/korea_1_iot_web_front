...
//    , 요소 뒤에 ?(물음표) 사용
//   >> 
fetchButton === null || fetchButton === void 0 ? void 0 : fetchButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    //# DOM 요소 가져오기
    const userDataDiv = document.getElementById('userData'); // 데이터 요청 결과에 따라 데이터를 넣어줄 div
    const userIdElement = document.getElementById('userId'); // 사용자의 id를 입력받을 input 요소
    ...
    if (userDataDiv) {
        ...
        try {
            ...
            const user = yield fetchResponse.json();
